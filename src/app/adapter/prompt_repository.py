...
class PromptRepository(IPromptRepository):
    ...
    def generate(self, game_details, character_name) -> Prompt:
        ...
        prompt = Prompt()
        prompt.prompt_string = """Act as though we are playing a Game of Dungeons and Dragons 5th edition. Act as though you are the dungeon master and I am the player. We will be creating a narrative together, where I make decisions for my character, and you make decisions for all other characters (NPCs) and creatures in the world.
...
The adventure is the D&D world or Ravenloft and should be written in the style of H.P. Lovecraft"""
        return prompt 

...
class PromptRepository(IPromptRepository):
    ...
    def generate(self, game_details) -> Prompt:
        ...
        prompt.prompt_string = (
            """Assume the role of an expert in the characters, scenarios, locations, and plot of  """
            + game_details.game_type
            + """. 
        As an expert be my Dungeon Master in a roleplaying game based on this adventure. 
        Give a narrative description of everything that follows, based on my actions, in the style of """
            + game_details.author
            + """, without taking control of me or my character. 
